...
public class Castle extends JFrame{
    ...
    class King extends JPanel{
        ...
        public King(FightCharacter ExPlayer){
            this.bgmPlayer = new BackgroundMusicPlayer("/Users/e235726/prog2/dokapon/app/src/main/java/jp/ac/uryukyu/ie/e235703_e235714_e235726_e235753_e235758/Dokapon_Screen/BGM/duel.wav");
            ...
            ExPlayer.setHP(ExPlayer.getDefaultHP());//仮
            add(conversation);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new Castle(ExPlayer).setVisible(true));
    }
}
